    ...
    <!-- elements du jeu -->
      <div id="game-container" class="relative">
        <div id="game-board" class="bg-indigo-200 rounded relative w-[800px] h-[400px] border border-violet-400">
          ...
          <div id="paddle-left" class="border border-violet-400 absolute rounded w-[10px] h-[80px] bg-white" style="left: 10px; top: 160px;"></div> <div id="paddle-right" class="border border-violet-400 absolute rounded w-[10px] h-[80px] bg-white" style="right: 10px; top: 160px;"></div>
        </div>
